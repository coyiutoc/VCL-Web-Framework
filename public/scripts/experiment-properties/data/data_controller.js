import {CUSTOM_CONDITIONS, get_subconditions} from "/scripts/experiment-properties/data/custom_subcondition_generator.js";
...
function get_data(experiment){
  ...
  if (CUSTOM_CONDITIONS[range].includes(condition)) {
  ...
  // If a base condition
    ...
    if (!EXPERIMENT_BASES[experiment_name][range]) {
      throw new Error ("Base for " + condition + " does not exist.");
    }

    dataset = EXPERIMENT_BASES[experiment_name][range];
  } 
