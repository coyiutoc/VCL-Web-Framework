...
const JND_SLICE = {
  ...
  foundational:
    [
    {base_radius: 2, initial_difference: 0.02, converge_from_above: true, text_color: 'BLACK', feedback_background_color: 'WHITE', background_color: 'WHITE', outline_color: 'BLACK', fill_color: 'WHITE'},

    {base_radius: 3, initial_difference: 0.02, converge_from_above: true, text_color: 'BLACK', feedback_background_color: 'WHITE', background_color: 'WHITE', outline_color: 'BLACK', fill_color: 'WHITE'},

    {base_radius: 4, initial_difference: 0.02, converge_from_above: true, text_color: 'BLACK', feedback_background_color: 'WHITE', background_color: 'WHITE', outline_color: 'BLACK', fill_color: 'WHITE'},

    {base_radius: 5, initial_difference: 0.02, converge_from_above: true, text_color: 'BLACK', feedback_background_color: 'WHITE', background_color: 'WHITE', outline_color: 'BLACK', fill_color: 'WHITE'},

    {base_radius: 6, initial_difference: 0.02, converge_from_above: true, text_color: 'BLACK', feedback_background_color: 'WHITE', background_color: 'WHITE', outline_color: 'BLACK', fill_color: 'WHITE'},
    ] 
}
